        ...
        stage('Deploy Application'){
            steps{
                sh """
                    ...
                    kubectl --kubeconfig=${WORKSPACE}/kube-config rollout restart deployment/minesweeper

                    kubectl --kubeconfig=${WORKSPACE}/kube-config rollout status deployment/minesweeper
                """
            }
        }
    }
